...
- 后端：Java 21，Spring Boot 3.4.1，模块 common/domain/application/infrastructure/interfaces/bootstrap；Spring Data JPA + Flyway 迁移（`releasehub-infrastructure/src/main/resources/db/migration`）；Spring Security + JWT 过滤器；springdoc OpenAPI；Lombok。
