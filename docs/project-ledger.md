...
| SA-010 解除挂载 GitLab 分支归档复核 | 已验证 | `scripts/acceptance/run-acceptance.sh` 4.2 | 2026-05-20 真实 GitLab 验收 | 独立窗口/迭代 attach 后 `release/<windowKey>` 存在；detach 后 `WindowIteration` 为空、原 release 分支删除、`archive/unpublished/release-<windowKey>` 存在 |
