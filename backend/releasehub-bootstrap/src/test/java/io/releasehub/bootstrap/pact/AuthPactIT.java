 ...
 *
 * Verifies that the backend implementation matches the contract
 * defined by the frontend consumer (in frontend/pacts/).
 */
...
class AuthPactIT {
    ...
    void adminUserExists() {
        // Seed data ensures admin/admin user exists for auth test
    }
}
