...
| [acceptance/sa002-safe-cleanup.sh](acceptance/sa002-safe-cleanup.sh) | SA-002 存量数据安全清理 dry-run 报告，输出可审计动作清单，不直接改库 | 验收前需要把 token 明文、BranchCreationMode、featureBranch、cloneUrl、DRAFT 残留转成清理计划时 |
