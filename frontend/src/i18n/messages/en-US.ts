export default {
  ...
  branchRule: {
    ...
    testBranchNamePlaceholder: 'Enter branch name to test',
    testRun: 'Test',
    testMatch: 'Match',
    testNoMatch: 'No match',
    namePlaceholder: 'Enter rule name',
    patternPlaceholder: 'Enter branch pattern, e.g. feature/{key} or ^release/.*$',
  ...
  calendar: {
    ...
    conflictTooltip: 'These windows are scheduled on the same day:'
  },
  group: {
    title: 'Groups',
    name: 'Name',
