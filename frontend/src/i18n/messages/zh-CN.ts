export default {
  ...
  branchRule: {
    ...
    typeRegex: '正则匹配',
    description: '描述',
    descriptionPlaceholder: '可选，规则描述',
    scope: '作用域',
    scopeLevel: '范围级别',
    scopeGlobal: '全局',
    scopeProject: '项目级',
    scopeSubProject: '子项目级',
    ...
    disable: '禁用',
    enableSuccess: '已启用规则',
    disableSuccess: '已禁用规则',
    test: '测试匹配',
    testPattern: '分支模式',
    testBranchName: '测试分支名',
    testBranchNamePlaceholder: '输入分支名进行测试',
    testRun: '测试',
    testMatch: '匹配成功',
    testNoMatch: '不匹配',
    namePlaceholder: '请输入规则名称',
    patternPlaceholder: '请输入分支模式，如 feature/{key} 或 ^release/.*$',
