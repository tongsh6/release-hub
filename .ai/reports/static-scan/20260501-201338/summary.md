...
- `.ai/FEATURE_DEVELOPMENT_GUIDE.md`
- `.ai/QUICK_REFERENCE.md`
- `.ai/README.md`
- `.ai/agents/design.md`
- `.ai/agents/implement.md`
- `.ai/agents/phase-router.md`
- `.ai/agents/proposal.md`
- `.ai/agents/test.md`
- `.ai/commands/code-review.md`
- `.ai/commands/fix-bug.md`
- `.ai/commands/implement-feature.md`
- `.ai/commands/plan-change.md`
- `.ai/commands/refactor.md`
- `.ai/commands/static-scan-topn.md`
- `.ai/summaries/experience-index.md`
- `.ai/templates/complete-blueprint.md`
- `.ai/templates/tasks-with-blueprint-trace.md`
- `.github/copilot-instructions.md`
- `AGENTS.md`
- `context/experience/INDEX.md`
- `context/experience/lessons/complete-blueprint-before-slicing.md`
- `context/experience/lessons/static-scan-topn-workflow.md`
...
- `context/tech/conventions/testing.md`
- `openspec/AGENTS.md`
- `scripts/dev/static-scan-topn.sh`
- `workflow/INDEX.md`
